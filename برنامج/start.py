...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("طـريقـه استخـدام البـوت☕🌿", callback_data="cbhowtouse")],
                [
                ...
                [
                    InlineKeyboardButton(
                        "جـروب الـدعم ᐬ", url=f"https://t.me/{GROUP_SUPPORT}"
                    ),
                    InlineKeyboardButton(
                        "قـنـاه السـورسᐬ", url=f"https://t.me/{UPDATES_CHANNEL}"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
@Client.on_message(
    command(["برمج السورس", f"سافو", f"سورس", f"لسورس", f"ادو", f"السورس"]) & filters.group & ~filters.edited
)
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton(
                    "سـورس دلـتاᐬ", url=f"https://t.me/L_S_A_V_O"
                ),
            ],
            [
    ...
    alive = f"ᴘʀᴏɢʀᴀᴍᴍᴇʀ [المبشمبـرمج سـافو](https://t.me/s_a_s_a_3li) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼"
        ...
        if member.id == bot_id:
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("قــنـاه السـورسᐬ", url=f"https://t.me/{UPDATES_CHANNEL}"),
                            InlineKeyboardButton("جـروب الـدعم ᐬ", url=f"https://t.me/{GROUP_SUPPORT}")
                        ],
                        [
                            InlineKeyboardButton(
